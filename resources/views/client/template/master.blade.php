...
<head>
    ...
    <link rel="apple-touch-icon-precomposed" sizes="144x144" href="{{asset("client/")}}assets/ico/apple-touch-icon-144-precomposed.png">
    <link rel="shortcut icon" href="{{asset("client")}}/assets/ico/favicon.ico">

    <!-- Icon-Font -->
    <link rel="stylesheet" href="{{asset("client")}}/assets/font-awesome/font-awesome/css/font-awesome.min.css" type="text/css">
    <!-- Google Fonts -->
            ...
            <div class="cart-content">
                ...
                <form>
                    ...
                    <div class="row text-xs-center">
                        <div class="col-sm-6">
                            <input class="button-yellow button-text-low button-long button-low" type="submit" value="Cập nhật">
                        </div>
                        <div class="col-sm-6 text-right text-xs-center">
                            <div class="margin-15"></div>
                            <a href="{{asset("client")}}/#section-delivery" class="button-yellow button-text-low button-long button-low scroll-to cart-trigger">Tiến hành thanh toán</a>
                        </div>
                    </div>
                </form>
            </div><!-- .cart-content -->
