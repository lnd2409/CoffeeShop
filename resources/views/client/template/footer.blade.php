    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4 text-center responsive-column">
                ...
                <p class="logo-footer-text">Đặt bàn - Đặt phòng</p>
                <p>Tiến hành đặt bàn và đặt phòng</p>
                <a  href="{{asset("client")}}/#section-menu" class="scroll-to button-yellow button-heavy">Đặt ngay</a>
            </div><!-- .col-md-4 -->
            <div class="col-md-4 responsive-column">
                <h2 class="footer-heading text-uppercase">Nhận ưu đãi</h2>
                <div class="margin-10"></div>
                <p>
                    <em>Nhập email quý khách để nhận thông tin khuyến mãi từ chúng tôi</em>
                </p>
                <form id="form-newsletter" class="form-subscribe" action="http://ignitionthemes.eu/theme/pizzeria/dark/assets/php/save_rss.php" method="post" data-email-not-set-msg="Email must be set." data-success-msg="Email added.">
                    <input type="email" name="email" placeholder="Nhập email . . .">
                    <div class="return-msg"></div>
                    <div class="text-right">
                        <input class="button-yellow button-heavy" type="submit" value="Gửi">
                    </div>
                </form>
            </div><!-- .col-md-4 -->
        </div><!-- .row -->
